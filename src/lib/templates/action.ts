...
export const actionTemplates: PromptTemplate[] = [
    ...
    },
    {
        ...
        category: 'mood',
        template:
            "A high-speed, dynamic photograph capturing a splash of water (or other liquid) interacting with {product}. The product is on a dark, wet slate surface. The lighting is high-speed strobe flash, freezing the motion of the liquid droplets in mid-air. Photographed with a Sony A1 and a 90mm Macro G lens. ISO 50. The shot is dramatic and energetic, yet retains an elegant and clean aesthetic, showcasing the product's durability.",
        variables: [
            {
                name: 'product',
                label: 'Product Description',
