...
export const technicalTemplates: PromptTemplate[] = [
    ...
    },
    {
        ...
        category: 'mood',
        template:
            'A diptych, two vertical panels. The left panel is a close-up, textural shot of {product}. The right panel is a wider shot showing the same product arranged neatly on a minimalist oak wall shelf in a serene, sunlit room. Photographed with a Fujifilm GFX 100S, ensuring consistent color and light across both panels. ISO 200. The format tells a story of both detail and application, feeling sophisticated and editorial.',
        variables: [
            {
                name: 'product',
                label: 'Product Description',
