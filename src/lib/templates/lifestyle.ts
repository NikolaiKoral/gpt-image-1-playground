...
export const lifestyleTemplates: PromptTemplate[] = [
    {
        ...
        tags: ['mood', 'vases', 'bowls', 'trays', 'decorative-items', 'wabi-sabi', 'japandi', 'living-room', 'centerpiece', 'wide-shot']
    },
    {
        ...
        tags: ['mood', 'bedding', 'throws', 'trays', 'personal-care', 'bedroom', 'minimalist', 'textiles', 'sanctuary', 'linen']
    },
    {
        ...
        tags: ['mood', 'sculptures', 'vases', 'candles', 'planters', 'japandi', 'shelf', 'vertical', 'minimalist', 'wall-shelf']
    },
    {
